...
class BookGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("jhipster_tstapp:mySecretOAuthSecret".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Book entity")
        ...
        .formParam("client_id", "jhipster_tstapp")
        ...
        .repeat(2) {
            ...
            .post("/api/books")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "img":null, "file":null}""")).asJSON
            .check(status.is(201))
